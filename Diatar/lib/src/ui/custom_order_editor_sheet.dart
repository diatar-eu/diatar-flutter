...
class _CustomOrderEditorPanelState extends State<CustomOrderEditorPanel> {
  ...
  late final ScrollController _orderListScrollController;
  ...
  void initState() {
    ...
    _orderListScrollController = ScrollController();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _updateHeaderActionsScrollIndicators();
    });
  ...
  Widget _buildCurrentOrderList() {
    ...
    return ClipRRect(
      borderRadius: BorderRadius.circular(8),
      child: Scrollbar(
        controller: _orderListScrollController,
          ...
          children: <Widget>[
            ...
            InlineTextEditor(
              ...
              labels: InlineTextEditorLabels(
                ...
                insertKotta: l10n.insertKotta,
                editKotta: l10n.editKotta,
              ),
              ...
              kottaEditorLabels: KottaEditorLabels(
                ...
                notes: l10n.kottaEditorNotes,
                rests: l10n.kottaEditorRests,
                accidentals: l10n.kottaEditorAccidentals,
                barlines: l10n.kottaEditorBarlines,
                gClef: l10n.kottaEditorGClef,
                fClef: l10n.kottaEditorFClef,
                noKeySignature: l10n.kottaEditorNoKeySignature,
                flats: l10n.kottaEditorFlats,
                sharps: l10n.kottaEditorSharps,
                whole: l10n.kottaEditorWhole,
                half: l10n.kottaEditorHalf,
                quarter: l10n.kottaEditorQuarter,
                eighth: l10n.kottaEditorEighth,
                sixteenth: l10n.kottaEditorSixteenth,
                dotted: l10n.kottaEditorDotted,
                natural: l10n.kottaEditorNatural,
                flat: l10n.kottaEditorFlat,
                sharp: l10n.kottaEditorSharp,
                doubleFlat: l10n.kottaEditorDoubleFlat,
                doubleSharp: l10n.kottaEditorDoubleSharp,
                cancel: l10n.cancel,
                apply: l10n.apply,
              ),
